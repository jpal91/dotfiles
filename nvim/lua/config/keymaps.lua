...
map("n", "<leader>dn", "<cmd> lua vim.diagnostic.goto_next() <cr>", { desc = "Go to next diagnostic message" })
map("n", "<leader>de", "<cmd> lua vim.cmd.RustLsp('run') <cr>", { desc = "Run selected item (Rust)" })
